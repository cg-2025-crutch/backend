...
import (
	...
	"github.com/cg-2025-crutch/backend/user-service/internal/users/handler"
...
func (s *GrpcServer) RegisterGRPC(srvc service.UserService) {
	pb.RegisterUserServiceServer(s.srv, handler.NewGRPCHandler(srvc))
}
