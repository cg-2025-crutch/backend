...
import (
	...
	"github.com/cg-2025-crutch/backend/notification-service/internal/notifications/handler"
...
func (s *GrpcServer) RegisterGRPC(srvc service.NotificationService) {
	gen.RegisterNotificationServiceServer(s.srv, handler.NewGRPCHandler(srvc))
}
